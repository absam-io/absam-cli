...
func GetServers() models.Servers {
	data, err := utils.Get("https://api.absam.io/v1/cloud-server/listall")
	if err != nil {
		utils.Die(err)
	}
...
func GetServerInfo(id string) models.SingleServer {
	url := "https://api.absam.io/v1/cloud-server/info?id=" + id
...
func GetServerStatus(id string) models.Status {
	url := "https://api.absam.io/v1/cloud-server/status?id=" + id
...
func ManageServer(action, id string) models.Result {
	reqUrl := "https://api.absam.io/v1/cloud-server/" + action
